...
const LogInModal = (props) => {
  ...
  return (
    <ModalProvider
      ...
      {...props}
    >
      <div className="sm:h-auto md:h-auto max-h-[97vh] w-[1200px] sm:w-full md:w-full items-start justify-start">
        <div className="bg-white-A700 border border-bluegray-100 border-solid flex flex-col items-start justify-start md:px-5 px-[30px] py-10 rounded-[10px] w-full">
          <div className="flex flex-col gap-8 items-center justify-center w-full">
            <div className="flex flex-col gap-4 items-start justify-start w-full">
              ...
              <div className="flex flex-row gap-5 items-center justify-between w-full">
                <CheckBox
                  ...
                  label="Remember"
                ></CheckBox>
                <Button className="bg-transparent cursor-pointer font-bold min-w-[144px] text-center text-gray-900 text-lg">
                  Forgot Password
                </Button>
              </div>
            </div>
            <div className="flex flex-col gap-[18px] items-start justify-start w-full">
              ...
              <Button
                className="common-pointer bg-white-A700 border border-gray-600 border-solid cursor-pointer flex items-center justify-center min-w-[420px] sm:min-w-full px-[34px] py-[17px] rounded-[10px] w-full"
                leftIcon={
                  <Img
            ...
            <div className="flex flex-row gap-2 items-start justify-center w-full">
              ...
              <Button className="bg-transparent cursor-pointer font-semibold min-w-[145px] text-center text-gray-900 text-xl tracking-[-0.40px]">
                Create Account
              </Button>
            </div>
          </div>
